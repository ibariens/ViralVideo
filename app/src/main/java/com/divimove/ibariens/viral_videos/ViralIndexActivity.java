 ...
 */
@TargetApi(13)
public final class ViralIndexActivity extends Activity implements OnFullscreenListener {
  ...
  private Video.VideoListFragment listFragment;
  private Video.VideoFragment videoFragment;
